        ...
        if(responses && responses.length > 0){
          ...
          function createMarker(place) {
            ...
            google.maps.event.addListener(marker2, 'click', function() {
              infoWindow2.setContent('<p style="font-size: 15px"> Place name : '+ place.name + '</p>' + '<br>'+ '<p style="font-size: 15px"> Place Photo : '+ photos+ '<img border="0" src=" ' + photos + ' "/>' + '</p>'+'<br><button class="button button-assertive"' +
